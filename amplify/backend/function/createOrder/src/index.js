...
const USER_POOL_ID = "eu-north-1_hYfxybezm";
const ORDER_TABLE = "Order-jlcpnowt5zfbdoofqdttm7gxpu-prod";
const ORDER_TYPE = "Order";
const BOOK_ORDER_TABLE = "BookOrder-jlcpnowt5zfbdoofqdttm7gxpu-prod";
const BOOK_ORDER_TYPE = "BookOrder";
const bucketName = "bookstoretestimages205647-prod";
  ...
  try {
    ...
    const message = {
      ...
      text: `Thank you for your order! Your order ID is ${payload.order_id}.
        ...
        \nThe payment was a test payment and no real money was transferred.
