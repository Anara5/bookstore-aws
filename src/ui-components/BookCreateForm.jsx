...
export default function BookCreateForm(props) {
  ...
  const [pdfdoc, setPdfdoc] = React.useState(initialValues.pdfdoc);
  ...
  const resetStateValues = () => {
    ...
    setPdfdoc(initialValues.pdfdoc);
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.pdfdoc ?? value;
          }
          if (errors.pdfdoc?.hasError) {
            runValidationTasks("pdfdoc", value);
          }
          setPdfdoc(value);
        }}
        onBlur={() => runValidationTasks("pdfdoc", pdfdoc)}
        errorMessage={errors.pdfdoc?.errorMessage}
        hasError={errors.pdfdoc?.hasError}
        {...getOverrideProps(overrides, "pdfdoc")}
      ></TextField>
      <TextField
        label="Author"
        isRequired={false}
